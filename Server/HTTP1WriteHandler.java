...
public class HTTP1WriteHandler {
    ...
    private enum WriteStates {
        RESPONSE_CREATING, RESPONSE_READY, RESPONSE_SENDING_HEADERS, RESPONSE_SENDING_BODY,
    ...
    public boolean isSending() {
        return currentWriteState == WriteStates.RESPONSE_READY || currentWriteState == WriteStates.RESPONSE_SENDING_BODY
                || currentWriteState == WriteStates.RESPONSE_SENDING_HEADERS || isSendingCGI();
    }
